...
const About = (props: Props) => {
  ...
  return (
    <div className="relative grid w-full md:grid-cols-2 md:py-8">
      <div className="col-span-1 w-full px-5 md:mt-5 md:w-[60%] md:px-[unset]">
        ...
        <Button
          className={`${styles.button} h-[45px] bg-[#2551b0] font-[500]`}
